...
```
R = spłata / pożyczka          (ile razy urosła kwota w złotych)
C = ceny w dniu spłaty / ceny w dniu startu
P = płace w dniu spłaty / płace w dniu startu
```

Wtedy definicje żalu z poprzedniej sekcji przyjmują postać:

```
żal dłużnika     = max( 0 ,  R/P − 1 )     spłata urosła bardziej niż płace
żal wierzyciela  = max( 0 ,  C/R − 1 )     ceny urosły bardziej niż spłata
żal umowy        = większy z obu
```
